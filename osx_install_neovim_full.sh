...
brew install git neovim stylua pyenv pyenv-virtualenv ninja libtool automake cmake pkg-config gettext curl ripgrep fd gnu-sed shellcheck shfmt curl jesseduffield/lazygit/lazygit rome
