...
dashboard.section.header.val = {
  [[                      neovim: the editor for keyboard users                     ]],
}
dashboard.section.buttons.val = {
  ...
  button(
    "k",
    icons.ui.CloudDownload .. " Sync knowledgebase to pi",
    ":!rsync -a /Users/molhoe000/Projects/knowledgebase pi:<CR>"
  ),
  button(
    "v",
    icons.ui.CloudDownload .. " Sync nvim config to pi",
    ":!rsync -a /Users/molhoe000/.config/nvim pi:.config/<CR>"
  ),
